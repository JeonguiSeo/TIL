...
## **Statement (실행문)**
### Sequential state (순차 실행문) : 일반적인 코드
### 제어 실행문 (indent 사용)
#### Conditional statements : True / False 조건에 따른 실행 문장 분기
##### 단일 if문
...
- Ture/False 대신 연산식을 주로 사용 (비교, 논리, 멤버십 연산자)
...
#### Loop statements (반복문) : True / False 조건에 따른 반복 실행
##### for문
- 특정 문장을 반복 처리
    - dummy 변수 사용 가능
...
- import를 통해 접근 가능
    - system에서 제공되는 module을 사용하기 위해 반드시 import 진행
